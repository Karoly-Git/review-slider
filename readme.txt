...
B)  HOW TO SETUP:
    ...
    2.  Add the following script to the end of the body in the HTML file.
        Make sure the 'src' points to the 'script.js' with the correct path.
    ...
    6.  Specify the following parameters in the 'script.js' file:
            ...
            const transitionType:   Transition type. ("ease", "ease-in", "ease-in-out", "ease-out")
